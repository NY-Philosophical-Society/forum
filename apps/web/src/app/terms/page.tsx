...
export const metadata: Metadata = {
  title: "Terms of Use — The New York Philosophy Club",
  description: "The rules of the forum, in plain language.",
};

/**
 * Apple requires terms (or a EULA) for apps carrying user-generated content,
 * together with a stated moderation policy and a mechanism for reporting
 * abuse — which is why the objectionable-content and enforcement sections
 * below name the actual in-product controls rather than gesturing at them.
 */
export default function TermsPage() {
  return (
    <div className="prose-page">
      ...
      <p>
        This is a real-name community. Register under the name you actually go
        by, because philosophy works better when people answer for what they
        say and can trust the person across from them. We run this on the
        honor system — we trust the name you give us. Impersonating someone
        else is grounds for removal.
      </p>
      ...
      <p>
        We may remove content, lock a thread, or suspend an account that breaks
        these rules. Moderation actions are recorded with the reason and who
        took them. We aim to review reports of harassment or objectionable
      ...
      <p>
        Reading and posting are free, and stay free. Membership — which
        supports the Club&apos;s events and journal — additionally opens
        chapters, the member directory, and event discussions. Donations
        support a non-profit and are not purchases of a service: they are not
        refundable, and membership does not entitle you to any particular
        content or outcome.
      </p>

      <h2>No warranty</h2>
      <p>
        The forum is provided as-is. We do our best to keep it running and to
      ...
      <p>
        Views expressed here belong to the people who post them, not to the New
        York Philosophy Club.
      </p>
