...
import { optionalAuth, requireAdmin, requireAuth } from "../guards";
import { toPublicUser } from "../serialize";
import { storageProvider } from "../storage-provider";
import { isFreshlyAuthenticated, supabaseAdmin } from "../supabase";
...
usersRouter.post(
  ...
  requireAuth,
  writeLimiter,
  rawBody({ type: AVATAR_ALLOWED_TYPES, limit: AVATAR_MAX_BYTES }),
  async (req, res) => {
