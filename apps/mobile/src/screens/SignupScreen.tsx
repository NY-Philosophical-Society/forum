  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <Text style={styles.subtitle}>
        ...
        listen. For now that runs on the honor system: we trust the name you give us, and you can
        post as soon as you sign up. If you'd like your identity confirmed rather than simply
        asserted, a one-time ID verification is built in and available any time from your
        profile.
      </Text>
